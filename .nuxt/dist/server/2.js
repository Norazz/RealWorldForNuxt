...
/* harmony default export */ var homevue_type_script_lang_js_ = ({
  ...
  async asyncData({
    ...
    const loadArticles = tab === 'your_feed' && store.state.user ? api_article["f" /* getFeedArticles */] : api_article["e" /* getArticles */]; // Promise.all并行执行接口请求，比串行执行没有依赖关系的请求，性能快
